        ...
        <div className="flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-gray-700 mb-4 text-lg">
              <span className="font-semibold text-pink-500">InspireMe</span> is a modern web app designed to motivate and uplift you with meaningful quotes.<br/>
              <span className="font-semibold text-indigo-500">Features:</span>
              <ul className="list-disc list-inside text-left ml-4 mt-2">
                <li>Random inspirational quote generator</li>
                <li>Beautiful, responsive design</li>
                <li>Easy navigation and user-friendly interface</li>
                <li>Built with React & Tailwind CSS</li>
              </ul>
              <span className="inline-block mt-4 text-indigo-600 font-medium">Stay inspired, every day!</span>
            </p>
